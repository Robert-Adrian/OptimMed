...
public class PacientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_gallery, R.id.nav_slideshow, R.id.nav_history, R.id.nav_reports)
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        headerName.setText(pacient.getUtilizator());
        TextView headerEmail = (TextView)findViewById(R.id.textView);
        headerEmail.setText(pacient.getEmail());
        return true;
    }
